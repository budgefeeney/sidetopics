...
from sidetopics.model.ctm import printStderr, verifyProper, LN_OF_2_PI, \
    LN_OF_2_PI_E, DTYPE
from sidetopics.util.array_utils import normalizerows_ip
from sidetopics.util.overflow_safe import safe_log_one_plus_exp_of
...
from sidetopics.util.misc import static_var, converged, clamp
