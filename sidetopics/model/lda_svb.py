...
import sidetopics.model.lda_vb_fast as compiled
...
from sidetopics.model.lda_cvb0 import toWordList
...
def newTrainPlan(iterations=100, epsilon=2, logFrequency=10, fastButInaccurate=False, debug=DEBUG,
    ...
    then stop.
    '''
    return TrainPlan(iterations, epsilon, logFrequency, fastButInaccurate, debug, batchSize, rate_retardation, forgetting_rate)
